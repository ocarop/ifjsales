...
return [
    ...
    'services' => [
        'events' => [
            ...
            'mautic.integration.js.subscriber' => [
                'class'     => 'MauticPlugin\MauticCrmBundle\EventListener\BuildJsSubscriber',
                'arguments' => [
        ...
        'integrations' => [
            ...
            'mautic.integration.infojobssales' => [
                'class'     => \MauticPlugin\MauticCrmBundle\Integration\InfojobsSalesIntegration::class,
                'arguments' => [
